...
namespace deltaPCo2 {
  ...
  enum class Keywords {
    sampling_kw=1, logging_kw, period_kw, duration_kw, rate_kw, frequency_kw, timetable_kw,

    add_kw, all_kw, alter_kw, and_kw, as_kw, avg_kw, auto_increment_kw,
    ...
    false_kw, float_kw, foreign_kw, from_kw, full_kw, group_kw, help_kw,
    ...
    table_kw, tables_kw, true_kw, unknown_kw, unique_kw, update_kw, use_kw,
